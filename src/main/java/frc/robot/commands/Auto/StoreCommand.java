...
public class StoreCommand extends SequentialCommandGroup {
    ...
    public StoreCommand(ArmSubsystem armSubsystem, WristSubsystem wristSubsystem, GripperSubsystem gripperSubsystem) {
        addCommands(
            ...
            new ArmWristCommand(new ArmCommand(Arm.minDegrees, 130, 160, armSubsystem), new WristCommand(Wrist.maxDegrees, 120, 100, wristSubsystem, armSubsystem), -1, 100, armSubsystem, wristSubsystem, gripperSubsystem)
        );
    }
